...
class Auth extends CI_Controller
{
	...
	public function index()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->load->view('layout/authheader');
	...
	public function cek_login()
	{
		...
		if ($user) {
			...
			$this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert"><i class="icon fas fa-info-circle"></i>Email Belum Terdaftar!</div>');
			redirect('auth');
		}
	}
